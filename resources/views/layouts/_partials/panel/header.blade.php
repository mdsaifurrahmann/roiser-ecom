                ...
                <li class="nav-item dropdown dropdown-user-setting">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                        ...
                        <div class="user-setting">
                            <img src="{{ auth()->user()->profile_image ? Storage::url('users/' . auth()->user()->profile_image) : asset('assets/images/avatars/06.png') }}"
                        ...
                        <li>
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex flex-row align-items-center gap-2">
                                    <img src="{{ auth()->user()->profile_image ? Storage::url('users/' . auth()->user()->profile_image) : asset('assets/images/avatars/06.png') }}"
                                        alt="{{ auth()->user()->name }}" class="rounded-circle" width="54"
                                        height="54">
                                    <div class="">
                                        <h6 class="mb-0 dropdown-user-name">{{ strtoupper(auth()->user()->name) }}</h6>
                                        <small
                                            class="mb-0 dropdown-user-designation text-secondary">{{ auth()->user()->getRoleNames()[0] }}</small>
                                    </div>
                                </div>
                            </a>
                        </li>
